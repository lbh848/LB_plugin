...
//@display-name soya comfy manager plugin v1.0.23
//@api 3.0
//@version 42.0.32
//@author soya
...
// Configuration/status-only companion for soya-v59.
  ...
  const renderDashboard = (force = false) => {
    ...
    document.body.innerHTML = `
      ...
      <main id="${ROOT_ID}"><div class="shell">
        <header><div><h1>soya comfy manager v1.0.23</h1><div class="sub">v42.0.32 · 자동/수동 삽화 버튼 감시 · 에셋 리롤 · KEYVISUAL 안정화</div></div><button id="lb-v42-close">닫기</button></header>
