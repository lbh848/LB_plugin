...
//@display-name soya comfy manager plugin v1.0.17
//@api 3.0
//@version 42.0.26
//@author soya
...
// Configuration/status-only companion for soya-v53.
  ...
  const renderDashboard = (force = false) => {
    ...
    document.body.innerHTML = `
      ...
      <main id="${ROOT_ID}"><div class="shell">
        <header><div><h1>soya comfy manager v1.0.17</h1><div class="sub">v42.0.26 · 자동/수동 삽화 버튼 감시 · 에셋 리롤 · fallback 엑박 숨김</div></div><button id="lb-v42-close">닫기</button></header>
